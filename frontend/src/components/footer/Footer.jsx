        ...
        <footer aria-label="Site Footer" className="bg-white dark:bg-black">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">Our skilled coaches will lead you through well-crafted lessons, helping you build a strong strategic foundation while enhancing your critical thinking and decision-making skills.</p>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-base/relaxed text-gray-500">
                        ...
                        Created with &nbsp;
                        <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">Chess Master</a>
                    </p>
                </div>
