...
const ManageClasses = () => {
    ...
    }, [page, classes]); // Update based on page and classes
    ...
    const handleApprove = (id) => {
        axiosSecure.put(`/change-status/${id}`, { status: 'approved' })
            .then(res => {
                ...
                if (res.data.modifiedCount > 0) { // Ensure this matches your backend response
            ...
            .catch(err => {
                ...
                Swal.fire(
                    'Error!',
                    'There was an error approving the class.',
                    'error'
                );
            });
    };
    ...
    const totalPage = Math.ceil(classes.length / itemPerPage); // Correct total pages calculation
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <div className="flex gap-2">
                                                                <button
                                                                    ...
                                                                    className='text-[12px] bg-green-500 py-1 rounded-md px-2 text-white'>
                                                                    Approve
                                                                </button>
                                                                <button
