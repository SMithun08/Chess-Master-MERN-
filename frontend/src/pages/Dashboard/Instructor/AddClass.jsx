    ...
    return (
        <div className="">
            ...
            <form onSubmit={handleFormSubmit} className=" mx-auto p-6 bg-white rounded shadow">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            type="text"
                            required
                            placeholder='What is the language used?'
                            name='language'
                        />
                    </div>
                    <div className="mb-6">
                        <label className="block text-gray-700 font-bold mb-2" htmlFor="courselevel">
                           Course Level
                        </label>
                        <input
                            className="w-full border-secondary px-4 py-2 border rounded-md focus:outline-none focus:ring-blue-500"
                            type="text"
                            required
                            placeholder='What is the level of the course?'
                            name='courselevel'
                        />
                    </div>
                </div>
                ...
                <div className="grid gap-3 md:grid-cols-2">
                    <div className="mb-6">
                        <label className="block text-gray-700 font-bold mb-2" htmlFor="lectures">
                            Lectures
                        </label>
                        <input
                            className="w-full border-secondary px-4 py-2 border rounded-md focus:outline-none focus:ring-blue-500"
                            type="number"
                            required
                            placeholder='How many lectures are available?'
                            name='lectures'
                        />
                    </div>
                    <div className="mb-6">
